<?php
  ...
  $query = "INSERT INTO item_request (requester, campus, category, name, product_id, manufacturer, supplier, description, min_stock, unit) VALUES ('$username', '$campus', '$formCategory', '$formName', '$formSerial', '$formManufacturer', '$formSupplier', '$formDescription', $formStock, '$formUnit');";
  ...
  header("Location: cm_local_inv.php");
?>
