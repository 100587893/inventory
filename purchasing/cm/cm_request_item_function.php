<?php
  ...
  $query = "INSERT INTO item_request (requester, campus, category, name, product_id, manufacturer, supplier, description, min_stock) VALUES ('$username', '$campus', '$formCategory', '$formName', '$formSerial', '$formManufacturer', '$formSupplier', '$formDescription', $formStock);";
