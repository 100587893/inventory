<?php
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    $query = "INSERT INTO requests (r_id, username, campus, product_id, supplier, quantity, unit_price, status) VALUES ($rid, '$username', '$campus2', '$pid', '$supplier', $quantity, $price, 'approved');";
