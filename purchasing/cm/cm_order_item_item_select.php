    ...
    <div class="container">
      ...
      <table>
        <tr>
          <th>Product ID</th>
          <th>Product Name</th>
          <th style="width: 45%;">Product Image</th>
        ...
        <?php
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            $opt .= " <tr class='table-row' data-href='cm_order_item_add_item_information.php?id=$id'>
                        <td>$id</td>
                        <td>$name</td>
                        <td><image src='../../images/$pid.jpg' style='width: 100%;'></td>
                        <td>$description</td>
                      </tr>";
          }
