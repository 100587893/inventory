<?php
  ...
  if (isset($_GET['add'])) {
    ...
    $query = "UPDATE warehouse_inv SET quantity=(quantity+$quantity) WHERE product_id='$pid';";
...
<html>
    ...
    <table class="table1">
        ...
        $inv = $campus ."_inv";
            ...
            echo "<td><a href='wm_add_item.php?id=$productid'><button type='button'>Add</button></a></td>";
    				echo "</tr>";
    			}
    		}
  		?>
